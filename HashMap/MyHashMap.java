...
public class MyHashMap {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(mp.get("a"));  // return value of given key if exists otherwise returns null.
        System.out.println(mp.size()); // returns current size of map.
        System.out.println(mp.containsKey("f"));  // returns boolean value if key exists otherwise false.
